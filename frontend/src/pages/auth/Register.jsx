  ...
  return (
    <div className="h-screen flex justify-center items-center px-4 animate-fade-in">
      <div className="w-full max-w-[450px] p-12 text-center glass-card">
        <h2 className="text-3xl mb-2 font-display tracking-tight">Create Account</h2>
        <p className="text-text-muted text-sm mb-8">Join us for a premium cinema experience</p>
        <form className="text-left mb-6" onSubmit={handleSubmit}>
          <div className="mb-6">
            <label className="block text-xs text-text-muted mb-2 uppercase tracking-wide">Full Name</label>
            <input 
              type="text" 
          ...
          <button type="submit" className="w-full p-4 bg-primary text-white font-bold rounded-lg mt-4 uppercase tracking-wide hover:brightness-110 transition">Register</button>
        </form>
        <div className="mt-8 text-text-muted text-sm">
          Already have an account? <Link to="/login" className="text-primary font-bold hover:text-white transition">Login</Link>
        </div>
      </div>
    </div>
  );
